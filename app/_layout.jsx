    ...
    <Provider store={store}>
      <GluestackUIProvider config={config}>
        ...
        >
          ...
          <Stack.Screen name="product/Product" options={{ title: "Produtos", headerRight: () => <SetingsRightStack Comprimentar={false} /> }} />
          ...
          <Stack.Screen name="customer/Customer" options={{ title: "Clientes", headerRight: () => <SetingsRightStack Comprimentar={false} /> }} />
          ...
          <Stack.Screen name="results/Results" options={{ title: "Resultados", headerRight: () => <SetingsRightStack Comprimentar={false} /> }} />
          <Stack.Screen name="cashFlow/CashFlow" options={{ title: "Financeiro", headerRight: () => <SetingsRightStack Comprimentar={false} /> }} />
        </Stack>
      </GluestackUIProvider>
    </Provider>
  );
